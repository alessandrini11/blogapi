                    ...
                    <div class="w-full md:w-1/3 md:ml-2">
                        ...
                        <div class="">
                            ...
                            <div class="p-5 bg-white">
                                ...
                                <div class="">
                                    <div v-for="(cat,key) in categories" class="py-2 px-5 flex justify-between items-center border-b">
                                        <div  class="font-bold text-sm">
                                            <span><i class="far fa-folder mr-1"></i></span>{{ cat.nom }}
                                        </div>
                                        <div v-if="cat.articles.length > 1" :style="{background : cat.color}" class="text-white py-1 px-3 bg-yellow-500">
                                            {{ cat.articles.length }} Posts
                                        </div>
                                        <div v-else :style="{background : cat.color}" class="text-white py-1 px-3 bg-yellow-500">
                                            {{ cat.articles.length }} Post
                                        </div>
                                    </div>
                                </div>
                            </div>
